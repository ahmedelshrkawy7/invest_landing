...
//               >
//                 A token sale, sometimes referred to as an ICO, is form of crowd
//                 funding for digital currency-related projects. In token sales,
//                 purchasers buy units of a new currency in exchange for legal
//                 tender or other digital currencies, such as Bitcoin or Ethereum.
//               </div>
//             </div>
//           </div>
...
//                     >
//                       <span className="tm-blank tm-token-color1"></span>ICO
//                       supporters
//                     </li>
//                     <li
//                       className="wow fadeInUp"
...
//                       data-wow-delay="0.55s"
//                     >
//                       <span className="tm-blank tm-token-color2"></span>Team
//                       members
//                     </li>
//                     <li
//                       className="wow fadeInUp"
...
//                       data-wow-delay="0.55s"
//                     >
//                       <span className="tm-blank tm-token-color4"></span>Angel
//                       investors
//                     </li>
//                     <li
//                       className="wow fadeInUp"
...
//                       data-wow-delay="0.55s"
//                     >
//                       <span className="tm-blank tm-token-color5"></span>Bounty
//                       Fund
//                     </li>
//                   </ul>
//                 </div>
...
//                       data-wow-delay="0.55s"
//                     >
//                       <span className="tm-blank tm-token-color1"></span>Platform
//                       development
//                     </li>
//                     <li
//                       className="wow fadeInUp"
...
//                       data-wow-delay="0.55s"
//                     >
//                       <span className="tm-blank tm-token-color2"></span>Sales &
//                       marketing
//                     </li>
//                     <li
//                       className="wow fadeInUp"
...
//                       data-wow-delay="0.55s"
//                     >
//                       <span className="tm-blank tm-token-color4"></span>Legal
//                       expenses
//                     </li>
//                     <li
//                       className="wow fadeInUp"
...
//                       data-wow-delay="0.55s"
//                     >
//                       <span className="tm-blank tm-token-color5"></span>Strategy
//                       development
//                     </li>
//                   </ul>
//                 </div>
...
//             Bounty Fund Distribution (<span className="tm-white-c">5%</span> of
//             the total)
//           </h2>
